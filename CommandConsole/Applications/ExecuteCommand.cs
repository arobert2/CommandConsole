...
namespace CommandConsole
{
    ...
    {
        private int _id;
        public virtual string Name => "Command Engine";
        /// <summary>
        /// ID of task
        /// </summary>
        ...
        /// Help test.
        /// </summary>
        public virtual string Help => "This is the top level application. Type listcommands to list all commands.";
        /// <summary>
        ...
        public CommandEngine(int id)
        {
            ...
            foreach (var kp in LoadApps.AppsToLoad.Library)
                SubCommands.Library.Add(kp.Key, kp.Value);
        }
        /// <summary>
        ...
        public virtual void Execute(Object sender, string c)
        {
            while(!StopApp)
            {
